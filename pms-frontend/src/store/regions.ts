...
export const useRegionStore = defineStore('regions', {
  ...
  actions: {
    ...
    async fetchRegions() {
      ...
      this.error = null
      try {
        const response = await axiosInstance.get('/api/v1/admin/regions')
    ...
    async fetchRegion(id: number) {
      ...
      this.error = null
      try {
        const response = await axiosInstance.get(`/api/v1/admin/regions/${id}`)
    ...
    async createRegion(payload: CreateRegionPayload) {
      ...
      this.error = null
      try {
        const response = await axiosInstance.post('/api/v1/admin/regions', payload)
    ...
    async updateRegion(id: number, payload: UpdateRegionPayload) {
      ...
      this.error = null
      try {
        const response = await axiosInstance.put(`/api/v1/admin/regions/${id}`, payload)
    ...
    async deleteRegion(id: number) {
      ...
      this.error = null
      try {
        const response = await axiosInstance.delete(`/api/v1/admin/regions/${id}`)
